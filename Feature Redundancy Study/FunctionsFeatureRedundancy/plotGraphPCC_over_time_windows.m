function [h] = plotGraphPCC_over_time_windows(x, G)
...
positionsx = [8 8 8 5 6 5.5 5.5 5.5 6 6.5 7 6 6.5 6.5 2 2 1 1 3 ...
    3 xv(1:5)'+2];

positionsy = [2 3 1 0 0 1 2 3 2 2 9 9 8 7 0 4 1 3 1 3 yv(1:5)'+8];
